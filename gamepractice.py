...
surface = pygame.display.set_mode((480,480))  #i think this is size of play area
...
foodPos = [random.randrange(1,48)*10, random.randrange(1,48)*10]
foodStatus = True
